...
1. **MAAS_REF Updates**: All references to `MAAS_REF="v0.0.8"` in documentation and scripts are automatically updated to use the new release tag (e.g., `MAAS_REF="v1.0.0"`).

2. **What Gets Updated**:
   - Documentation files (`.md` files)
   - Deployment scripts (`.sh` files)
   - All variations: `export MAAS_REF="v0.0.8"`, `MAAS_REF="v0.0.8"`, `MAAS_REF:=v0.0.8`

3. **Usage**: 
   - For production deployments, use a release tag: `export MAAS_REF="v1.0.0"`
   - For development/testing, use: `export MAAS_REF="v0.0.8"`
